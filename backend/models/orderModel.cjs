...
const orderSchema = new mongoose.Schema(
  {
    ...
    dronePhase: {
      ...
      enum: [
        ...
        "recovery_required",
        "cancelled",
        "fallback_pending_customer_consent",
      ],
      default: "not_applicable",
      index: true,
      comment: "Pha vận hành độc lập của drone delivery state machine",
    },
    droneAssignedAt: {
      type: Date,
      default: null,
    ...
    droneHandoverAt: {
      type: Date,
      default: null,
      comment: "Thời điểm nhà hàng hoàn tất bàn giao món vào khoang hàng của drone",
    },
    dronePreflightStatus: {
      type: String,
      enum: ["none", "passed", "failed"],
      default: "none",
    },
    dronePreflightChecklist: {
      type: mongoose.Schema.Types.Mixed,
      default: null,
    },
    droneFallbackDeadlineAt: {
      type: Date,
      default: null,
      comment: "Hạn 10 phút chờ khách xác nhận chuyển sang shipper khi hết drone",
    },
    droneArrivedAt: {
      type: Date,
      default: null,
