...
const PRESET_LABELS = [
  { id: "home", label: "Nhà riêng", icon: "home" as IconName },
  { id: "work", label: "Công ty", icon: "store" as IconName },
  { id: "other", label: "Khác", icon: "map-pin" as IconName },
];
...
export const AddressEditorModal: React.FC<AddressEditorModalProps> = ({
  ...
  const content = (
      <KeyboardAvoidingView
        ...
        style={[styles.modalBackdrop, embedded && styles.embeddedBackdrop]}
      >
        <View style={styles.modalContainer}>
          ...
          >
            ...
            <View style={styles.presetRow}>
              {PRESET_LABELS.map((p) => {
                ...
                return (
                  ...
                  >
                    <Icon name={p.icon} size={17} color={active ? colors.primary : colors.textSecondary} />
                    <Text
                      style={[
                        styles.presetText,
            ...
            <View style={styles.gpsBox}>
              ...
              {hasCoords && (
                <View style={styles.coordsRow}><Icon name="map-pin" size={15} color={colors.primary} /><Text style={styles.coordsDisplay}>Lat: {lat?.toFixed(5)} · Lng: {lng?.toFixed(5)}</Text></View>
              )}
